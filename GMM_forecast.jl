...
####################################################
# Load the clean data generated by Flexibility_Compute_Drivers.R
...
data_AT = Float64.(Dates.value.(charging_sessions.session_start_time_la))
data_DT = Float64.(Dates.value.(charging_sessions.session_end_time_la))
...
if flag == "hour"
    charging_sessions.AT = Float64.(Dates.hour.(charging_sessions.session_start_time_la))
    charging_sessions.DT = Float64.(Dates.hour.(charging_sessions.session_end_time_la))
    charging_sessions.PD = ceil.(Dates.value.(charging_sessions.charging_end_time_la - charging_sessions.session_start_time_la) / (3600*1000), digits=0)
    # charging_sessions.PD = Float64.(Int64.(charging_sessions.PD))
elseif flag == "minute"
    charging_sessions.AT = Float64.(Dates.hour.(charging_sessions.session_start_time_la)) * 60 + Float64.(Dates.minute.(charging_sessions.session_start_time_la))
    charging_sessions.DT = Float64.(Dates.hour.(charging_sessions.session_end_time_la)) * 60 + Float64.(Dates.minute.(charging_sessions.session_end_time_la))
    charging_sessions.PD = ceil.(Dates.value.(charging_sessions.charging_end_time_la - charging_sessions.session_start_time_la) / (60*1000), digits=0)
    # charging_sessions.PD = Float64.(Int64.(charging_sessions.PD))
end
