...
print(first(max_power, 200))
Dates.hour(CP_data_clean.session_end_time_la[1])
(Dates.value(CP_data_clean.session_end_time_la[1]) - Dates.value(CP_data_clean.session_start_time_la[1])) / (3600 * 1000)
