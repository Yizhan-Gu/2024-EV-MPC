            ...
            if (method == "Persistence+KNN" || method == "Statistic+KNN") 
                ...
                elseif !isempty(arrived_sessions_today)
                    ...
                    if isempty(arrived_sessions_forecast)
                        ...
                        noarrived_sessions_today.ED = noarrived_sessions_today.ED * (1 + k / N)
                    elseif !isempty(arrived_sessions_forecast)
                        ...
                        noarrived_sessions_today.ED = min.(ED_candidate, P_max * (floor.(Int, noarrived_sessions_forecast.PD / T * N) .-2) * delta_t)
                        noarrived_sessions_today.ED = max.(noarrived_sessions_today.ED, 0)
                        ...
                        elseif EV_ratio > 1
                            ...
                            ED_candidate = noarrived_sessions_forecast.ED * sqrt(EV_ratio)
                            noarrived_sessions_forecast.ED = min.(ED_candidate, P_max * (floor.(Int, noarrived_sessions_forecast.PD / T * N) .-2) * delta_t)
                            noarrived_sessions_forecast.ED = max.(noarrived_sessions_forecast.ED, 0)
