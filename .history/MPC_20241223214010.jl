            ...
            if (method == "Persistence+KNN" || method == "Statistic+KNN") 
                ...
                elseif !isempty(arrived_sessions_today)
                    ...
                    elseif !isempty(arrived_sessions_forecast)
                        ...
                        noarrived_sessions_today.ED = min.(ED_candidate, P_max * (ceil.(Int, noarrived_sessions_forecast.PD / T * N)) * delta_t)
                        ...
                        elseif EV_ratio > 1
                            ...
                            noarrived_sessions_today = vcat(vcat([noarrived_sessions_forecast for _ in 1:n_duplicate]...), additional_sessions)
                        end
